...
data class ModeloCurso (
    ...
    fun exemplos(): List<ModeloCurso> {
        return listOf(
            ModeloCurso(
                id = 1, nivel = 1, status = Status.DISPONIVEL,
            ...
            ModeloCurso(
                id = 2, nivel = 1, status = Status.DISPONIVEL,
            ...
            ModeloCurso(
                id = 3, nivel = 2, status = Status.DISPONIVEL,
            ...
            ModeloCurso(
                id = 4, nivel = 2, status = Status.EM_BREVE,
            ...
            ModeloCurso(
                id = 5, nivel = 3, status = Status.DISPONIVEL,
            ...
            ModeloCurso(
                id = 6, nivel = 1, status = Status.DISPONIVEL,
            ...
            ModeloCurso(
                id = 7, nivel = 3, status = Status.INDISPONIVEL,
            ...
            ModeloCurso(
                id = 8, nivel = 1, status = Status.DISPONIVEL,
            ...
            ModeloCurso(
                id = 9, nivel = 1, status = Status.DISPONIVEL,
            ...
            ModeloCurso(
                id = 10, nivel = 3, status = Status.EM_BREVE,
            ...
            ModeloCurso(
                id = 11, nivel = 2, status = Status.DISPONIVEL,
            ...
            ModeloCurso(
                id = 12, nivel = 1, status = Status.DISPONIVEL,
